module.exports =  {
    run: async (message, args) => {
        if(!message.member.hasPermission('BAN_MEMBER')) return message.channel.send('Vous n\'avez pas la permission d\'utiliser cette commande.')
        ...
        message.channel.send(`${member.user.tag} a été bannit !`)
    },
    name: 'ban',
    guildOnly: true
}